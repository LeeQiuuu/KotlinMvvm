...
import com.jimi.app.utils.ToastUtil
...
abstract class BaseFragment<VM : BaseViewModel, VB : ViewBinding> : Fragment() {
    ...
    open fun showToast(msg: String?, duration: Int) {
        if (isResumed) ToastUtil.showToast(requireActivity(), msg, duration)
    }

    open fun showToast(resId: Int, duration: Int) {
        if (isResumed) ToastUtil.showToast(requireActivity(), resId, duration)
    }
