...
import com.jimi.app.mvvm.utils.LogUtil.showHttpApiLog
import com.jimi.app.mvvm.utils.LogUtil.showHttpHeaderLog
import com.jimi.app.mvvm.utils.LogUtil.showHttpLog
import com.jimi.app.protocol.CookieUtils.cookie
...
class LoggingInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        var api = httpUrl.toString().replace(Constant.API_HOST, "")
        if (api.contains("?")) {
